...
const s = StyleSheet.create({
  ...
  navScroll: { paddingHorizontal: 16, paddingVertical: 12, backgroundColor: '#FFF', borderBottomWidth: 1, borderBottomColor: '#E5E0DB' },
  navItem: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 12, marginRight: 8, flexDirection: 'row', alignItems: 'center' },
  navLabel: { fontSize: 13, fontWeight: '600', color: '#8A8A8A', marginLeft: 6 },
