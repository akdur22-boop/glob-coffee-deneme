  ...
  return (
    <SafeAreaView style={s.container}>
      <View style={s.content}>
        ...
        <View style={s.card}>
          <View style={s.row}><Feather name="map-pin" size={18} color="#800020" /><View style={s.rowText}><Text style={s.label}>Teslim Noktası</Text><Text style={s.value}>{storeName}</Text></View></View>
          <View style={s.divider} />
          <View style={s.row}><Feather name="clock" size={18} color="#800020" /><View style={s.rowText}><Text style={s.label}>Tahmini Süre</Text><Text style={s.value}>10-15 dakika</Text></View></View>
          <View style={s.divider} />
          <View style={s.row}><Feather name="credit-card" size={18} color="#800020" /><View style={s.rowText}><Text style={s.label}>Toplam</Text><Text style={s.value}>₺{parseFloat(total || '0').toFixed(0)}</Text></View></View>
        </View>
        <View style={s.pointsBanner}><Feather name="star" size={20} color="#800020" /><Text style={s.pointsText}>Bu siparişle <Text style={s.pointsBold}>+{pointsEarned} puan</Text> kazandınız!</Text></View>
...
const s = StyleSheet.create({
  ...
  pointsBanner: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF0F2', borderRadius: 14, paddingHorizontal: 20, paddingVertical: 14, marginBottom: 32 },
  pointsText: { fontSize: 14, color: '#5C5C5C', marginLeft: 10 }, pointsBold: { fontWeight: '700', color: '#800020' },
